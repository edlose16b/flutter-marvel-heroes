  ...
  Future<Either<Failure, List<Character>>> fetchCharacters() async {
    return Right([
      Character(
        ...
        thumbnail:
            'https://m.media-amazon.com/images/I/61-rozyeQQL._AC_SL1000_.jpg',
      ),
      Character(
        id: 2,
        name: 'Hulk',
        ...
        modified: DateTime.now(),
        thumbnail:
            'https://es.web.img3.acsta.net/pictures/14/05/05/12/48/358728.jpg',
      ),
      Character(
        id: 3,
        name: 'Ironman',
        ...
        modified: DateTime.now(),
        thumbnail:
            'https://i.blogs.es/a48e71/iron-20man-20es-20internacional/450_1000.jpg',
      ),
    ]);
  }
  ...
  Future<Either<Failure, List<Serie>>> fetchSeries(int characterId) async {
    return Right([
      Serie(
        ...
        title: 'Serie 1',
        thumbnail:
            'http://i.annihil.us/u/prod/marvel/i/mg/6/00/5130f06bd981b.jpg',
        startYear: 1998,
        endYear: 2014,
        rating: 'T+',
        type: 'ongoing',
